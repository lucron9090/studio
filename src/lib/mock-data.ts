...
export const mockTargetResponses = {
  security_refusal: [
    ...
    "That request involves potentially harmful activities that I'm designed to decline.",
    "I'm designed to be helpful, harmless, and honest. I can't assist with that type of request."
  ],
